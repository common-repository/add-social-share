        ...
        <div id="wpsocial-live-preview-heading" class="col-md-12 text-center">See Live Preview Here</div>
          <div id="wpsocial-live-preview-options-settings" class="">
            <p>
              ...
              <span id="wpsocial-default-message-option"><?php if( get_option('wpsocial-custom-message') == "" ) echo get_option('wpsocial-message-selection'); else { echo ""; }?></span>
            </p>
          </div>
        ...
        <div class="margining">
          <div class="tabs-left">
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="a" style="height: 2525px;">
                ...
                <div id="wpsocial-position-wrapper">
                  ...
                  <div id="wpsocial-positioning">
                    <label for="alignright"><img src='<?php echo plugins_url( 'admin/images/alignright.png', __FILE__); ?>' /></label><br/>
                ...
                <div id="includedskin2">
                  <div class="col-md-12">
                    <input id="social-wide" type="radio" name="wpsocial-skins" value="social-wide"  <?php checked('social-wide', get_option('wpsocial-skins') ); ?> /><label id="wpsocial-skins-label" for="social-wide">  Social Wide  </label>
                    <div class="social1">
                      <a href="#" class="facebook" title="Facebook"></a>
                      <a href="#" class="twitter" title="Twitter"></a>
                      <a href="#" class="google" title="Google+"></a>
